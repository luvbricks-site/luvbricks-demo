  ...
  return (
    <div>
      ...
      <p className="mt-2 text-med text-slate-700">
        ...
        <strong> Tier 1-2:</strong> you pay standard ground by packed weight (see table below).
        <strong> Tier 3:</strong> a flat <strong>$12.50</strong> after a <strong>$5 LuvBricks credit</strong>
        (full ground for this tier averages about <strong>$17.50</strong>).
        <strong> Tier 4:</strong> a flat <strong>$10.00</strong> after a <strong>$10 LuvBricks credit</strong>
        (full ground for this tier averages about <strong>$20.00</strong>).
        Items under $26 (MSRP-only) follow the standard ground rate by weight.
      ...
      {/* Tier 1-2 weight table */}
      <div className="mt-6">
        <div className="text-sm font-semibold text-slate-900">Tier 1-2 Ground Rates (Customer Pays)</div>
        <table className="mt-2 w-full text-sm text-slate-700 border-collapse">
          ...
          <tbody>
            ...
            <tr>
              <td className="py-2 pr-4">&ge; 12.5 lb (any tier)</td>
              <td className="py-2">$38.00 (FedEx Express Saver)</td>
            </tr>
          </tbody>
        </table>
        <p className="mt-2 text-sm text-slate-500">
          Rates apply to the packed shipment weight (we combine items in the same order). Tier 3 and Tier 4 carts
